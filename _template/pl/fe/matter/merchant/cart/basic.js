ngApp.provider.controller('ctrlCart', ['$scope', '$http', 'Cart', 'Sku', function($scope, $http, Cart, Sku) {
	...
	$scope.gotoShop = function() {
		var url;
		url = '/rest/site/fe/matter/merchant/shelf?site=' + $scope.siteId + '&shop=' + $scope.shopId + '&page=' + $scope.shellId;
		location.href = url;
	};
