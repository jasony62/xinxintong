      ...
      myLoc = {
        ...
        j: function (method) {
          ...
          for (var i = 1, l = arguments.length; i < l; i++) {
            search.push(
              arguments[i] + '=' + ($location.search()[arguments[i]] || '')
            )
          }
...
ngMod.service('http2', [
  ...
  '$sce',
  '$compile',
  function ($rootScope, $http, $timeout, $q, $sce, $compile) {
    ...
    function _requirePagination(oOptions) {
      if (oOptions.page && angular.isObject(oOptions.page)) {
        ...
        if (
          oOptions.page.j === undefined ||
          !angular.isFunction(oOptions.page.j)
        ) {
