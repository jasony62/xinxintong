...
var PicViewer = function(selector, options) {
    ...
    var hammertime, vendorPrefixes = ["", "-webkit-", "-moz-", "-o-", "-ms-", "-khtml-"],
        elImg, viewHeight, viewWidth, minScale, maxScale, currentScale, lastScale, scaleX, scaleY, lastX, lastY, toX, toY;
...
oPicViewer = new PicViewer('#picViewer img', {
    next: next,
    prev: prev,
    close: fnClose
});
