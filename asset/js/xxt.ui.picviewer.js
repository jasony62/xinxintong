...
ngMod.factory('picviewer', ['$q', function ($q) {
    ...
    _picviewer.prototype.imgStatusRewrite = function (idx) {
        ...
        var imgStatus = this.imgStatusCache[index],
            currentScale = imgStatus.scale,
            currentX = imgStatus.x,
            currentY = imgStatus.y;
        imgStatus.x = 0;
        imgStatus.y = 0;
        imgStatus.m = 0;
        imgStatus.my = 0;
    ...
    _picviewer.prototype.render = function () {
        ...
        this.containerData = this.imgStatusCache[this.cIndex] = {
            elem: this.container,
            x: this.winw,
            y: 0,
            m: 0,
        ...
        this.boxData = this.imgStatusCache[this.bIndex] = {
            elem: this.box,
            x: 0,
            y: 0,
            m: 0,
