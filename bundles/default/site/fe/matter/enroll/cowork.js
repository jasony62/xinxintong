...
/* 公共加载的模块 */
var angularModules = ['ngSanitize', 'ui.bootstrap', 'notice.ui.xxt', 'http.ui.xxt', 'page.ui.xxt', 'snsshare.ui.xxt', 'siteuser.ui.xxt', 'favor.ui.xxt', 'directive.enroll'];
/* 加载指定的模块 */
...
var oUtilSchema = __webpack_require__(19);
...
window.moduleAngularModules = ['editor.ui.xxt', 'repos.ui.enroll', 'tag.ui.enroll', 'topic.ui.enroll'];
...
ngApp.controller('ctrlCowork', ['$scope', '$q', '$timeout', '$location', '$anchorScroll', '$sce', '$uibModal', 'tmsLocation', 'http2', 'noticebox', 'tmsDynaPage', 'enlTag', 'enlTopic', function($scope, $q, $timeout, $location, $anchorScroll, $sce, $uibModal, LS, http2, noticebox, tmsDynaPage, enlTag, enlTopic) {
    ...
    function fnAfterLoad(oRecord, oUser) {
        /*设置任务提示*/
        if (_oApp.actionRule) {
            var oCoworkRule;
...
// module
exports.push([module.i, "img{max-width:100%}@media screen and (max-width:768px){.site-navbar-default{margin-bottom:0}}hr{margin:12px 0 12px}blockquote{font-size:16px}button.option{padding:0}p{word-break:break-all}.glyphicon.like{color:#ff8018}.top-bar>*+*{margin-left:8px}.bottom-bar{display:flex;align-items:center}.bottom-bar>*+*{margin-left:16px}.bottom-bar>*+* .like{color:#ff8018}.bottom-bar>:first-child{flex-grow:1}.bottom-bar a{text-decoration:none;color:#777}.bottom-bar .btn-default{color:#777}.bottom-bar .dropdown button{border:0}#cowork,#record,#remarks{padding:16px;background:#fff}#record .title{margin:0 -1rem .5rem -1rem;background:#ddd;padding:.5rem 1rem;border-bottom:1px solid #ccc}#record .title .dropdown-menu{right:0;left:auto;min-width:auto}#record .top-bar{display:flex}#record .top-bar .nickname{flex-grow:1}#record .top-bar .label{padding:.3em .6em}#record .data blockquote>div+div{margin-top:8px}#cowork .data-title:before,#record .data .data-title:before{content:' ';display:inline-block;width:12px;height:12px;border-top:6px solid #fff;border-right:6px solid #fff;border-bottom:6px solid #fff;border-left:6px solid #ff8018}.tags{margin-top:8px}.tags>button+button{margin-left:4px}#favorGuide{position:fixed;align-items:center;z-index:1051;width:100%;bottom:0;display:flex;border:1px solid #bce8f1;background:#d9edf7;padding:8px 16px;color:#31708f}#favorGuide>:first-child{flex-grow:1}#favorGuide>:last-child{margin-left:4px}#cowork{position:relative;margin-top:1rem}#remarks{position:relative;margin-top:3rem}#cowork .item{position:relative;transition:background 1s}#cowork .blink{background:#d9edf7}#remarks:before{content:'\\7559\\8A00';position:absolute;left:50%;margin-left:-1em;top:-2em;font-size:.7em;color:#eee;padding:.2em 1em;background:#666;border-radius:1em}#remarks .remarkList{background:#fff;min-height:167px;margin-bottom:30px}#remarks .remark{position:relative;background:#fff;border-bottom:1px solid #ddd;transition:background 1s;padding:8px 0}#remarks .remark:last-child{border-bottom:0}#remarks .remark>*{margin:1em 0 .2em}#remarks .blink{background:#d9edf7}#remarks .form-control{border-radius:0}.tag{background:#3af;padding:4px 6px;margin:4px;border-radius:2px;font-size:.8em;color:#fff}.tms-editor{position:absolute;top:8px;bottom:8px;left:8px;right:8px;display:flex;flex-direction:column}.tms-editor>:first-child{position:relative;flex-grow:1;margin-bottom:8px;border:1px solid #ddd;border-radius:4px;overflow-y:auto}.tms-editor>:first-child iframe{display:block;width:100%;border:0}", ""]);
...
if(false) {
	module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!./cowork.css", function() {
		var newContent = require("!!../../../../../../node_modules/css-loader/index.js!./cowork.css");
