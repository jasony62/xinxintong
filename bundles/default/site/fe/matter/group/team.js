...
ngApp.config(['$routeProvider', function($routeProvider) {
    $routeProvider
        .when('/rest/site/fe/matter/group/team/create', { template: __webpack_require__(118), controller: 'ctrlTeamCreate' })
        .when('/rest/site/fe/matter/group/team/config', { template: __webpack_require__(117), controller: 'ctrlTeamConfig' })
        .otherwise({ template: __webpack_require__(119), controller: 'ctrlTeamHome' });
}]);
