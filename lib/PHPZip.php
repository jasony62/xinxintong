...
class PHPZip  {  
    ...
    {  
        ...
        $header['filename'] = $this->_iconvConvert($header['filename']);  
    ...
    {  
        ...
        for($i=0; $i < $count; $i++)  
        {  
            if(intval($count) != $count || $count > $cdir['entries'])  
            {  
                return(-1);  
            }  
        ...
        {  
            ...
            {  
            	$stat['name'] = $header['filename'];
                $stat['state'] = $this->ExtractFile($header, $to, $zip);  
            }  
        }  
    ...
    {  
        ...
        {  
            ...
            $header['index'] = $i;  
            $info = array(  
                'filename'        => $this->_iconvConvert($header['filename']),       // 文件名  
