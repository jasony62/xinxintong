		...
		if ($channel->matter_type === 'article') {
			...
			foreach ($simpleMatters as $sm) {
				...
				if ($sm->matter_type !== 'article') {
					...
					$q = [
						"a.id,a.title,a.creater_name,a.create_at,a.summary,a.pic,a.state,'article' type,a.matter_cont_tag,a.matter_mg_tag,s.name site_name,s.id site_id,s.heading_pic",
