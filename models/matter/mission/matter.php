...
class matter_model extends \TMS_MODEL
{
  ...
  public function byMission($missionId, $matterType = null, $aOptions = [], $verbose = 'Y')
  {
    ...
    /* 按频道过滤 */
    if (!empty($aOptions['byChannel'])) {
      $q[2]['byChannel'] = (object) ['op' => 'exists', 'pat' => 'select 1 from xxt_channel_matter cm where mm.matter_type=cm.matter_type and mm.matter_id=cm.matter_id and channel_id=' . $aOptions['byChannel']];
    }
