...
class memberschema_model extends \TMS_MODEL {
    ...
    public function create($oSite, $oUser, $oConfig = null) {
        ...
        $oNewMschema->attr_email = '101000'; // 默认隐藏邮箱
    ...
    public function listRelateSchema($site, $id) {
        ...
        if ($schema->matter_type === 'mission' && $schema->matter_id !== '') {
            $qm = [
                'ms.id,ms.title,ms.matter_id,ms.matter_type,ms.create_at,ms.ext_attrs',
            ...
            //项目本身其它的通讯录
            $qmi = [
                'id,title,matter_id,matter_type,create_at,ext_attrs',
                'xxt_site_member_schema',
