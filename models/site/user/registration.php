...
class registration_model extends \TMS_MODEL
{
  ...
  public function create($siteId, $uname, $password, $aOptions = [])
  {
    ...
    $is_smscode_register = empty($aOptions['is_smscode_register']) ? 0 : $aOptions['is_smscode_register'];
    ...
    $registration->is_smscode_register = $is_smscode_register;
  ...
  public function validate($uname, $password)
  {
    ...
    if ($pw_hash != $oRegistration->password) {
      if (TMS_APP_PASSWORD_ERROR_MAXNUM > 0) {
