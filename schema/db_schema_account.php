...
$sql .= ",pwd_error_num int default 0 comment '密码输入错误次数'";
$sql .= ",login_limit_expire int default 0 comment '禁止登录到期时间'";
...
$sql .= ",p_create_self_site tinyint not null default 0 comment '创建用户的默认团队'";
