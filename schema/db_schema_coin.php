...
$sql .= ",actor_delta int not null default 0"; // 进行操作的用户增加的行为分
$sql .= ",actor_overlap char(1) not null default 'A'"; // 和上级行为分规则冲突时的处理方式，A：累加，R：替换
$sql .= ",creator_delta int not null default 0"; // 素材创建者增加的行为分
