...
$sqls[] = "alter table xxt_wall_enroll change openid openid varchar(255) ";
$sqls[] = "alter table xxt_wall_enroll add wx_openid varchar(255) not null default '' after openid";
