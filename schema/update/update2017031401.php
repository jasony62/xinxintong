...
$sql .= ",modifier varchar(40) not null"; // 生成版本的账号
...
$sqls[] = "alter table xxt_template change put_at put_at int not null default 0";
...
$sqls[] = "alter table xxt_template add create_at int not null after creater_name";
//
