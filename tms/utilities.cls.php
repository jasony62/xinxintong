...
class PwdStrengthCheck
{
  ...
  private function _charactersOnly($passwordData)
  {
    ...
    return ($passwordData['lower']['count'] + $passwordData['upper']['count'] == $passwordLength) ? -$passwordLength : 0;
  }
  /**
   * @param array $passwordData Formatted password data
   * @return integer Resulting score
  ...
  {
    $passwordLength = strlen($passwordData['raw']);
    return ($passwordData['symbol']['count'] == $passwordLength) ? -$passwordLength : 0;
  }
  /**
   * @param array $passwordData Formatted password data
   * @return integer Resulting score
  ...
  {
    $passwordLength = strlen($passwordData['raw']);
    return ($passwordData['number']['count'] == $passwordLength) ? -$passwordLength : 0;
  }
  /**
   * @param array $passwordData Formatted password data
   * @return integer Resulting score
