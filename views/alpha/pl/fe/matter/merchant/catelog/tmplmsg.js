(function() {
    ngApp.provider.controller('ctrlTmplmsg', ['$scope', 'http2', '$uibModal', function($scope, http2, $uibModal) {
        $scope.orderEvts = [{
            id: 'submit_order',
            label: '用户提交订单'
        }, {
        ...
        $scope.choose = function(orderEvt) {
            var url;
            url = '/rest/pl/fe/matter/tmplmsg/mappingGet';
        ...
        $scope.clean = function() {
            if (window.confirm('确定清除？')) {
                ...
                url = '/rest/pl/fe/matter/merchant/tmplmsg/clean';
        ...
        $scope.save = function() {
            ...
            url = '/rest/pl/fe/matter/merchant/tmplmsg/setup';
