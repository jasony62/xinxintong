(function() {
    ngApp.provider.controller('InnerMemberSelectorCtrl', ['$scope', 'http2', function($scope, http2) {
        var checkedDepts = [],
            checkedTags = [],
            checkedMembers = [];
        ...
        $scope.searchMember = function() {
            ...
            url = '/rest/pl/fe/site/member/list?site=' + $scope.$parent.siteId + '&schema=' + $scope.$parent.memberschema.id;
