...
$view['params']['global_js'] = array(array('angular-route.min', 'bootstrap.min', 'ui-bootstrap.min', 'ui-bootstrap-tpls.min', 'tinymce/tinymce.min'), array('ui-tms', 'matters-xxt', true));
