...
$view['params']['global_js'] = array(array('angular-route.min', 'angular-sanitize.min', 'bootstrap.min', 'ui-bootstrap.min', 'ui-bootstrap-tpls.min', 'resumable'), array('ui-tms', 'xxt.ui', true));
