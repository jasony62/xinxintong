define(["require", "angular", "base", "cookie", "directive"], function(require, angular, app, Cookies) {
    'use strict';
    app.controller('ctrl', ['$scope', '$http', '$timeout', 'Cart', 'Sku', function($scope, $http, $timeout, Cart, Sku) {
        ...
        facCart = new Cart();
        facSku = new Sku($scope.mpid, $scope.shopId);
        $scope.errmsg = '';
        /*产品过滤条件*/
        ...
        $http.get('/rest/app/merchant/shelf/get?mpid=' + $scope.mpid + '&page=' + pageId).success(function(rsp) {
            ...
            loadCss("/views/default/app/merchant/shelf.css");
