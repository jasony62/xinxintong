xxtApp.controller('deptSelectorCtrl',['$scope','http2','$modalInstance','abid','onlyOne',function($scope,http2,$modalInstance,abid,onlyOne) {
    ...
    $scope.ok = function () {
        $modalInstance.close(checkedDept);
    };
