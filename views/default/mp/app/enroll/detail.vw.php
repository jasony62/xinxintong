...
$view['params']['global_js'] = array('tinymce/tinymce.min', 'xxt.ui', 'angular-sanitize.min', true);
$view['params']['angular-modules'] = "'ngRoute','ngSanitize','channel.matter.mp','ui.xxt','ui.bootstrap'";
