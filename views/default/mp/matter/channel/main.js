xxtApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/rest/mp/matter/channel/edit', {
        templateUrl: '/views/default/mp/matter/channel/edit.html',
        controller: 'editCtrl',
    }).when('/rest/mp/matter/channel/read', {
        templateUrl: '/views/default/mp/matter/channel/read.html',
        controller: 'readCtrl',
    }).when('/rest/mp/matter/channel/stat', {
        templateUrl: '/views/default/mp/matter/channel/stat.html',
        controller: 'statCtrl'
    }).otherwise({
        templateUrl: '/views/default/mp/matter/channel/edit.html',
        controller: 'editCtrl'
