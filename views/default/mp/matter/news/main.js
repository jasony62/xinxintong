xxtApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/rest/mp/matter/news/edit', {
        templateUrl: '/views/default/mp/matter/news/edit.html',
        controller: 'editCtrl',
    }).when('/rest/mp/matter/news/read', {
        templateUrl: '/views/default/mp/matter/news/read.html',
        controller: 'readCtrl',
    }).when('/rest/mp/matter/news/stat', {
        templateUrl: '/views/default/mp/matter/news/stat.html',
        controller: 'statCtrl'
    }).otherwise({
        templateUrl: '/views/default/mp/matter/news/edit.html',
        controller: 'editCtrl'
