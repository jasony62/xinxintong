angular.module('carouselApp', []).filter("maskmobile", function() {
    ...
    $scope.stop = function() {
        var getWinner = function() {
            ...
            if (winner) {
                ...
                $http.post('/rest/op/enroll/lottery/done?aid=' + $scope.aid + '&rid=' + $scope.round + '&ek=' + winner.enroll_key, {
    ...
    $scope.getPersons = function() {
        $http.get('/rest/op/enroll/lottery/playersGet?aid=' + $scope.aid + '&rid=' + $scope.round + '&hasData=N').
