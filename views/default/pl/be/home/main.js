define(['frame'], function (ngApp) {
    ...
    ngApp.provider.controller('ctrlHomeCarousel', ['$scope', 'mediagallery', function ($scope, mediagallery) {
        var slides;
        $scope.add = function () {
            var options = {
    ...
    ngApp.provider.controller('ctrlHomeQrcode', ['$scope', 'mediagallery', function ($scope, mediagallery) {
        var qrcodes;
        $scope.add = function () {
            var options = {
                callback: function (url) {
