...
define(['main'], function(ngApp) {
    ngApp.provider.controller('ctrlOther', ['$scope', 'http2', 'matterTypes', function($scope, http2, matterTypes) {
        ...
        $scope.setReply = function() {
            mattersgallery.open($scope.wx.plid, function(aSelected, matterType) {
                if (aSelected.length === 1) {
                    ...
                    http2.post('/rest/pl/be/sns/wx/other/setreply?site=' + $scope.wx.plid + '&id=' + $scope.editing.id, p).then(function(rsp) {
        ...
        http2.get('/rest/pl/be/sns/wx/other/list?site=' + $scope.wx.plid).then(function(rsp) {
