angular
  .module('service.article', ['ui.bootstrap', 'ui.xxt'])
        ...
        return {
          list: function (article, page, type, criteria) {
            ...
            switch (type) {
              case 'favor':
                url =
                  '/rest/pl/fe/matter/article/favor/list?site=' +
                  article.siteid +
                  '&id=' +
                  article.id
                break
              case 'download':
                url =
                  '/rest/pl/fe/matter/article/log/attachmentLog?site=' +
                  article.siteid +
                  '&appId=' +
                  article.id
                break
  ...
  .provider('srvApp', function () {
    ...
    this.$get = [
      ...
      'noticebox',
      'srvSite',
      function ($q, http2, noticebox, srvSite) {
        return {
          get: function () {
            var defer = $q.defer(),
              url
      ...
      function ($q, http2) {
        return {
          list: function (articleSiteId, articleId, page) {
            ...
            url =
              '/rest/pl/fe/matter/article/coin/logs?site=' +
              articleSiteId +
              '&id=' +
              articleId +
              page._j()
