define([
  ...
  'enrollPage',
  'groupService',
], function (RouteParam, CstApp, frameTemplates) {
  'use strict'
  ...
  ngApp.config([
    ...
    'srvEnrollAppProvider',
    'srvEnrollPageProvider',
    'srvEnrollRecordProvider',
    'srvTagProvider',
    'srvEnrollSchemaProvider',
    'srvEnrollLogProvider',
    function (
      $provide,
      $controllerProvider,
      $routeProvider,
  ...
  ngApp.controller('ctrlFrame', [
    ...
    'srvEnrollApp',
    '$location',
    function ($scope, CstNaming, CstApp, srvSite, srvEnlApp, $location) {
