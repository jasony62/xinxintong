define(['schema', 'wrap', 'matterSchema'], function (schemaLib, wrapLib) {
     ...
     * 所有题目
     */
    ngMod.controller('ctrlSchemaList', ['$scope', '$timeout', '$sce', '$uibModal', 'noticebox', 'http2', 'CstApp', 'srvMatterSchema', 'srv' + window.MATTER_TYPE + 'App', 'srvEnrollPage', 'srvEnrollSchema',
        function ($scope, $timeout, $sce, $uibModal, noticebox, http2, CstApp, srvMatterSchema, srvApp, srvAppPage, srvEnrollSchema) {
