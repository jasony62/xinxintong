define(['frame', 'schema', 'wrap'], function(ngApp, schemaLib, wrapLib) {
     ...
     * 登记项管理
     */
    ngApp.provider.controller('ctrlMainVer1', ['$scope', function(){
        alert();
    }]);
    //ngApp.provider.controller('ctrlMainVer1', ['$scope', 'cstApp', 'srvEnrollPage', 'srvEnrollApp', function($scope, cstApp, srvEnrollPage, srvEnrollApp) {
