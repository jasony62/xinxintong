define(['frame'], function(ngApp) {
    'use strict';
    ngApp.provider.controller('ctrlMain', ['$scope', 'http2', '$q', 'mattersgallery', 'noticebox', 'srvGroupApp', '$uibModal', function($scope, http2, $q, mattersgallery, noticebox, srvGroupApp, $uibModal) {
