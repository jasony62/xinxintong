(function() {
    app.provider.controller('ctrlMatter', ['$scope', 'http2', function($scope, http2) {
        ...
        $scope.fetch = function() {
            http2.get('/rest/pl/fe/matter/mission/matter/list?site=' + $scope.siteId + '&id=' + $scope.id, function(rsp) {
