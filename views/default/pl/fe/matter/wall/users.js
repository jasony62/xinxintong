(function() {
    xxtApp.register.controller('usersCtrl', ['$scope', '$uibModal', 'http2', function($scope, $uibModal, http2) {
        ...
        $scope.doSearch = function() {
            http2.get('/rest/pl/fe/matter/wall/users/list?wall=' + $scope.wid, function(rsp) {
        ...
        $scope.import = function() {
            $uibModal.open({
                ...
                http2.get('/rest/pl/fe/matter/wall/users/import?wall=' + $scope.wid + '&app=' + app.id, function(rsp) {
        ...
        $scope.export = function() {
            $uibModal.open({
                ...
                var url;
                url = '/rest/pl/fe/matter/wall/users/export?wall=' + $scope.wid;
        ...
        $scope.quit = function() {
            ...
            if (vcode === $scope.wall.title) {
                http2.get('/rest/pl/fe/matter/wall/users/quit?wall=' + $scope.wid, function(rsp) {
                    $scope.users = null;
