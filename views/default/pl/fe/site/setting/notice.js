define(['main'], function (ngApp) {
  'use strict'
  ngApp.provider.service('serNotice', [
    '$q',
    'http2',
    function ($q, http2) {
  ...
  ngApp.provider.controller('ctrlNotice', [
    '$scope',
    'http2',
    '$uibModal',
    'serNotice',
    'noticebox',
    function ($scope, http2, $uibModal, serNotice, noticebox) {
      ...
      http2
        .get(
          '/rest/pl/fe/matter/tmplmsg/list?site=' +
            $scope.siteId +
            '&cascaded=Y'
        )
        .then(function (rsp) {
      ...
      http2
        .get('/rest/pl/fe/matter/tmplmsg/list?site=platform&cascaded=Y')
        .then(function (rsp) {
        ...
        $uibModal
          .open({
            ...
            controller: [
              ...
              'tmplmsgs',
              'plTmplmsgs',
              function ($mi, $scope2, tmplmsgs, plTmplmsgs) {
