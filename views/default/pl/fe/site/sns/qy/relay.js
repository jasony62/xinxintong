define(['main'], function(ngApp) {
    ...
    ngApp.provider.controller('ctrlRelay', ['$scope', 'http2', function($scope, http2) {
        $scope.add = function() {
            http2.get('/rest/pl/fe/site/sns/qy/relay/add?site=' + $scope.siteId).then(function(rsp) {
        ...
        http2.get('/rest/pl/fe/site/sns/qy/relay/list?site=' + $scope.siteId).then(function(rsp) {
