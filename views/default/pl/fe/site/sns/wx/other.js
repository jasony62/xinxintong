define(['main'], function(ngApp) {
    ...
    ngApp.provider.controller('ctrlOther', ['$scope', 'http2', 'matterTypes', 'srvSite', function($scope, http2, matterTypes, srvSite) {
        ...
        $scope.setReply = function() {
            srvSite.openGallery({
                ...
                if (result.matters.length === 1) {
                    ...
                    http2.post('/rest/pl/fe/site/sns/wx/other/setreply?site=' + $scope.siteId + '&id=' + $scope.editing.id, p).then(function(rsp) {
        ...
        http2.get('/rest/pl/fe/site/sns/wx/other/list?site=' + $scope.siteId).then(function(rsp) {
