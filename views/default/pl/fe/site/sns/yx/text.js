define(['main'], function(ngApp) {
    ...
    ngApp.provider.controller('ctrlText', ['$scope', 'http2', 'matterTypes', 'srvSite', function($scope, http2, matterTypes, srvSite) {
        ...
        $scope.create = function() {
            srvSite.openGallery({
                ...
                if (result.matters.length === 1) {
                    ...
                    http2.post('/rest/pl/fe/site/sns/yx/text/create?site=' + $scope.siteId, result.matters[0]).then(function(rsp) {
        ...
        $scope.remove = function() {
            http2.get('/rest/pl/fe/site/sns/yx/text/delete?site=' + $scope.siteId + '&id=' + $scope.editing.id).then(function(rsp) {
        ...
        $scope.edit = function(call) {
            if (call.matter === undefined) {
                http2.get('/rest/pl/fe/site/sns/yx/text/cascade?site=' + $scope.siteId + '&id=' + call.id).then(function(rsp) {
        ...
        $scope.setReply = function() {
            srvSite.openGallery({
                ...
                if (result.matters.length === 1) {
                    ...
                    http2.post('/rest/pl/fe/site/sns/yx/text/setreply?site=' + $scope.siteId + '&id=' + $scope.editing.id, p).then(function(rsp) {
        ...
        http2.get('/rest/pl/fe/site/sns/yx/text/list?site=' + $scope.siteId + '&cascade=n').then(function(rsp) {
