...
define(['main'], function(ngApp) {
    ...
    ngApp.provider.controller('ctrlDetails',['$scope', 'http2', function($scope, http2){
...
//ngApp.provider.controller('ctrlProfile', ['$scope', 'http2', '$uibModalInstance', '$uibModal', 'params', function($scope, http2, $mi, $uibModal, params) {
//	var baseURL = '/rest/pl/fe/site/user/profile/',
