var app = angular.module('xxt', ['infinite-scroll']);
...
app.controller('ctrl', ['$scope', '$http', '$location', function ($scope, $http, $location) {
    ...
    $scope.doSearch = function () {
        $scope.loading = true;
        var url = '/rest/site/fe/matter/addressbook/get?siteid=' + $scope.siteId + '&abid=' + $scope.id;
    ...
    $http.get('/rest/site/fe/matter/addressbook/deptGet?siteid=' + $scope.siteId + '&id=' + $scope.id).success(function (rsp) {
