...
ngMod.directive('tmsScoreRecordData', [function () {
    return {
        ...
        controller: ['$scope', 'tmsLocation', 'http2', 'noticebox', function ($scope, LS, http2, noticebox) {
            ...
            $scope.submit = function () {
                ...
                http2.post(url, {
                    ...
                    var url = LS.j('marks/renewReferScore', 'site');
                    url += '&app=' + _oScoreApp.id;
                    url += '&task=' + $scope.task.id;
                    http2.post(url, {}).then(function () {
            ...
            http2.get(LS.j('get', 'site') + '&app=' + _oScoreApp.id + '&task=' + $scope.task.id + '&page=IGNORE').then(function (rsp) {
