            ...
            $scope.chooseFile = function (schemaId, count, accept) {
                ...
                ele.addEventListener('change', function (evt) {
                    ...
                    for (i = 0; i < cnt; i++) {
                        ...
                        if ($scope.fileConfig.maxsize !== 0 && $scope.fileConfig.maxsize * 1024 * 1024 <= f.size) {
    ...
    $scope.$on('xxt.app.enroll.ready', function (event, params) {
        ...
        if (!$scope.isSmallLayout) {
            ...
            angular.forEach(pasteContains, function (pastecontain) {
                ...
                html += '<button class="btn btn-default" ng-click="pasteImage(\'' + oSchema.id + '\',$event,' + oSchema.count + ')">点击按钮<br>Ctrl+V<br>粘贴截图';
