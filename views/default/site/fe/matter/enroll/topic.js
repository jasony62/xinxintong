...
ngApp.controller('ctrlTopic', ['$scope', '$q', 'http2', 'tmsLocation', '$timeout', 'picviewer', 'noticebox', 'enlTask', function ($scope, $q, http2, LS, $timeout, picviewer, noticebox, enlTask) {
    /* 是否可以对记录进行表态 */
