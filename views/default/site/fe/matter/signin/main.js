...
var setShareData = function (scope, params) {
  ...
  if (
    params.page.share_summary &&
    params.page.share_summary.length &&
    params.record
  )
  ...
  window.xxt.share.set(
    params.app.title,
    sharelink,
    summary,
    params.app.pic || params.app.pic
  )
...
ngApp.controller('ctrlMain', [
  ...
  'tmsLocation',
  'tmsDynaPage',
  function ($scope, $timeout, http2, LS, tmsDynaPage) {
    ...
    function openAskFollow() {
      http2.get(LS.j('askFollow', 'site')).then(
        function () {},
        function (content) {
          var body, el
          body = document.body
